...
echo "  Duplex:      $(cat /var/lib/scanner/duplex_mode 2>/dev/null || echo 'on')"
echo "  ADF DPI:     ${SCAN_DPI:-300}"
echo "  Flatbed DPI: ${FLATBED_DPI:-600}"
echo "  Output:      /output"
echo ""
echo "Commands:"
echo "  docker exec scanner toggle-color     # switch Color/Gray"
echo "  docker exec scanner toggle-duplex    # switch Simplex/Duplex"
echo "  docker exec scanner scan-flatbed     # scan from flatbed glass"
